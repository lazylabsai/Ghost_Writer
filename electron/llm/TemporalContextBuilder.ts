 ...
 */
function formatPreviousResponses(responses: AssistantResponse[], maxResponses: number = 5): string[] {
    ...
    return recent.map(r => {
        // Keep enough context for the LLM to understand the full previous answer
        const text = r.text.length > 500
